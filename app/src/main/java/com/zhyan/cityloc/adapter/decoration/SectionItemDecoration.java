package com.zhyan.cityloc.adapter.decoration;
...
public class SectionItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionItemDecoration(Context context, List<City> data) {
        ...
        mBgColor = context.getResources().getColor(R.color.wheat);
...
//        mSectionHeight = context.getResources().getDimensionPixelSize(typedValue.resourceId);
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.cp_list_item_text_size);
